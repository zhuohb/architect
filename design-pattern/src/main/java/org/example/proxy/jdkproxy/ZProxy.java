...
public class ZProxy {
	...
	public static Object newProxyInstance(ZClassLoader classLoader, Class<?>[] interfaces, ZInvocationHandler h) {
		try {
			//动态生成源代码.java文件
			...
			Constructor c = proxyClass.getConstructor(ZInvocationHandler.class);
			f.delete();
	...
	private static String generateSrc(Class<?>[] interfaces) {
		...
		sb.append(ZProxy.class.getPackage() + ";" + ln);
		sb.append("import " + interfaces[0].getName() + ";" + ln);
		sb.append("import java.lang.reflect.*;" + ln);
		sb.append("public class $Proxy0 implements " + interfaces[0].getName() + "{" + ln);
		sb.append("ZInvocationHandler h;" + ln);
		sb.append("public $Proxy0(ZInvocationHandler h) { " + ln);
		sb.append("this.h = h;");
		sb.append("}" + ln);
